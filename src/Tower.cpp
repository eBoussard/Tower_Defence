...
Tower::Tower(gridPosition gridX, gridPosition gridY):Price_(20), Damage_(100), shootingSpeed_(100), Range_(100), sellValue_(15), gridX_(gridX), gridY_(gridY), towerBitmapSize_(48)
{
      al_init();
      al_init_image_addon();
